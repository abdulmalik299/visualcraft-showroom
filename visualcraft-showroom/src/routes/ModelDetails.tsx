    ...
    <div className="container-pad py-10">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="card p-6">
          ...
          <p className="mt-4 text-sm text-slate-300 whitespace-pre-line">{item.description}</p>
            ...
            {item.isFree ? (
              ...
              <>
                ...
                <div className="text-xs text-slate-400">
                  After successful payment, you can send your receipt screenshot to the contact email/WhatsApp to receive the
                  download link—fully serverless. (Upgrade to Cloud Functions later for auto-unlock.)
                </div>
              </>
            ) : (
